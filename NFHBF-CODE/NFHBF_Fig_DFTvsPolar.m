...
d=lambda/2;
Nr=8;Nt=128; % number of RX/TX antennas 
...
for reali=1:Realization
    ...
    for i=1:length(SNR)
        ...
        %         [SUPP_OMP_6bit,Gain_omp_6bit,~] = SOMP_MMV(OV,A_6bit,P,M,Nsub,d,lambda,I);% SJG-HBF based on OMP-MMV, Q=64
        %
        ...
        [SUPP_4bit,Gain_4bit,~] = LC_SOLS_MMV(OV,A_4bit,P,M,Nsub,d,lambda); % SIG-HBF based on OLS-MMV, Q=16
        [SUPP_6bit,Gain_6bit,~] = LC_SOLS_MMV(OV,A_6bit,P,M,Nsub,d,lambda); % SIG-HBF based on OLS-MMV, Q=16
